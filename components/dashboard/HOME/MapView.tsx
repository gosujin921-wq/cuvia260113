                        ...
                        if (zoomLevel === 0) {
                            return (
                                <div
                                    ...
                                    onClick={() => {}}>
                                    <div className={`${getCCTVIconClassName("light")} flex items-center justify-center ${item.count > 1 && zoomLevel === 0 ? "w-auto min-w-[28px]" : ""}`} style={getCCTVIconBoxStyle(item.count, mapScale, item.count > 1 && zoomLevel === 0, 60)}>
                                        <CCTVIcon className="!text-gray-300 drop-shadow-lg filter" style={{ color: "#d1d5db" }} width="16px" height="16px" />
                                    ...
                                    {showCCTVName && <div className={`${getCCTVLabelClassName("default")} absolute top-full left-1/2 -translate-x-1/2 mt-1`}>{cctvName}</div>}
                                    {showCCTVViewAngle &&
                                        (() => {
                                                    ...
                                                    return (
                                                        <div
                                                            ...
                                                            <svg width="120" height="120" viewBox="0 0 120 120" style={{ position: "absolute", top: 0, left: 0, pointerEvents: "none" }}>
                                                                <path d={pathData} fill="rgba(156, 163, 175, 0.15)" stroke="rgba(156, 163, 175, 0.5)" strokeWidth="1.5" />
                                                            </svg>
                                                        </div>
                                                    );
                                                });
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    <svg width="120" height="120" viewBox="0 0 120 120" style={{ position: "absolute", top: 0, left: 0, pointerEvents: "none" }}>
                                                        <path d={pathData} fill="rgba(156, 163, 175, 0.2)" stroke="rgba(156, 163, 175, 0.6)" strokeWidth="2" />
                                                    </svg>
                                                </div>
                                            );
                                        })()}
                                                ...
                                                return (
                                                    <div
                                                        ...
                                                        {...(shouldChangeToBlue
                                                            ...
                                                            : {})}>
                                                        <CCTVIcon className={shouldChangeToBlue ? "text-blue-400" : "!text-gray-300"} style={shouldChangeToBlue ? { color: "#60a5fa" } : { color: "#d1d5db" }} width="16px" height="16px" />
                                                    </div>
                                                );
                                            })()}
                                            {showCCTVName && <div className={`${getCCTVLabelClassName("default")} absolute top-full left-1/2 -translate-x-1/2 mt-1`}>CCTV-V-{index + 1}</div>}
                                            {showCCTVViewAngle &&
                                                (() => {
                                                    ...
                                                    if (isEvent1Selected) {
                                                        const cctvPositions = [{ viewAngle: 45 }, { viewAngle: 90 }, { viewAngle: 135 }, { viewAngle: 180 }, { viewAngle: 225 }, { viewAngle: 270 }, { viewAngle: 315 }, { viewAngle: 0 }, { viewAngle: 60 }, { viewAngle: 120 }];
                                ...
                                <div
                                    ...
                                    {(() => {
                                        const samePositionEvents = events.filter((e) => {
                                            ...
                                            const distance = Math.sqrt(Math.pow(position.left - otherPosition.left, 2) + Math.pow(position.top - otherPosition.top, 2));
                                            return distance < 1;
                                        });
                                        const clusterCount = samePositionEvents.length;
                                        const hasMultiple = clusterCount > 1 && zoomLevel === 0;

                                        const cctvLabel = isEvent1 ? "CCTV-V-11" : cctvIndex !== undefined && cctvIndex !== null && cctvIndex >= 1 && cctvIndex <= 10 ? CCTV_TITLES[cctvIndex - 1] : null;
                                        ...
                                        return (
                                            <>
                                                <div
                                                    ...
                                                    {isEvent1 ? <CCTVIcon className={isSelected ? "text-red-400 drop-shadow-lg" : "!text-gray-300"} style={isSelected ? {} : { color: "#d1d5db" }} width="16px" height="16px" /> : <Icon icon="mdi:map-marker" className="text-red-400" width="16px" height="16px" />}
                                                ...
                                                {cctvLabel && (
                                                    <div className={`${isEvent1 ? getCCTVLabelClassName(isSelected ? "tracking" : "default") : getCCTVLabelClassName("tracking")} absolute top-full left-1/2 -translate-x-1/2 mt-1 whitespace-nowrap`} style={{ opacity: isEvent1 ? 1 : zoomLevel > 0 ? 1 : 0 }}>
                                                        {cctvLabel}
                                                    </div>
                                                )}
                                                {isEvent1 && isSelected && (

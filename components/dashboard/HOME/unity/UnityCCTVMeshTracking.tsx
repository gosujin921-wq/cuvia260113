...
const UnityCCTVMeshTracking: React.FC<UnityCCTVMeshTrackingProps> = ({ event, cctvName, cctvRtspURL, position, isMain, width = 420, hideControls = false, highlighted = false, onHover, cctvId }) => {
                ...
                <div className="flex-shrink-0">
                    <div className="px-3 pb-3">
                        <div className="w-full bg-[#0f0f0f] border border-[#31353a] rounded-md overflow-hidden relative" style={{ borderWidth: "1px", aspectRatio: "16/9" }}>
                            <video src={cctvRtspURL} autoPlay loop muted playsInline className="w-full h-full object-cover" />

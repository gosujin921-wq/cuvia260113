    ...
    return (
        <div
            ...
            <div className="mb-4 pb-4 border-b border-gray-700/50 w-full flex justify-center">
                <img src="/logo.svg" alt="CUVIA" className="h-8 w-auto object-contain" style={{ filter: "brightness(0) invert(1)" }} />
            </div>
                            ...
                            <div className="relative">
                                ...
                                {isActive ? (
                                    <div
                                        ...
                                        />
                                        <Icon icon={item.icon} className="w-5 h-5 transition-all duration-200 text-white" />
                                    </div>
                                ) : (
                                    <Icon icon={item.icon} className="w-7 h-7 transition-all duration-200 text-gray-400 group-hover:text-white" />
                                )}
            ...
            {/* 쿠비아 링크 */}
            <a href="/cuvia-link" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center w-full group" aria-label="CUVIA 웹사이트" tabIndex={0}>
                <svg className="transition-all duration-200 text-gray-400 group-hover:text-white" style={{ width: "22.4px", height: "22.4px" }} viewBox="0 0 57.5 51.66" fill="currentColor">
                ...
                <span className="text-[10px] font-medium mt-1.5 transition-all duration-200 text-gray-400 group-hover:text-white">CUVIA Link</span>
            </a>
        </div>
    );
};

export default PropagationLeftMenu;

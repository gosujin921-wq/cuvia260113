...
const LeftPanel = ({ onCollapsedChange }: LeftPanelProps = {}) => {
    ...
    useEffect(() => {
        ...
        // 다음 정각 10분까지 기다린 후 1시간 간격으로 업데이트
        const timeoutId = setTimeout(() => {
            updateSensorData();
            intervalId = setInterval(updateSensorData, 60 * 60 * 1000); // 1시간
            ...
            <div className="flex-1 overflow-hidden pt-4 pb-4 pl-4 pr-5 flex flex-col gap-4" ref={scrollContainerRef} style={{ maxWidth: "100%", height: "100%" }}>
                ...
                <div className="rounded-lg px-4 pt-4 pb-3 gradient-border-left-top" style={{ flexShrink: 0, background: "linear-gradient(135deg, rgba(0,0,0,0.6) 0%, rgba(23,23,23,0.6) 100%)", backdropFilter: "blur(4px)", WebkitBackdropFilter: "blur(4px)" }}>
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-gray-400 text-xs">마지막 업데이트: {weatherData1?.fcst_time || "--:--"}</span>
                    </div>
                ...
                <div className="rounded-lg px-4 pt-4 pb-4 gradient-border-left-top flex flex-col relative overflow-hidden" style={{ flex: 1, minHeight: "180px", background: "linear-gradient(135deg, rgba(0,0,0,0.6) 0%, rgba(23,23,23,0.6) 100%)", backdropFilter: "blur(4px)", WebkitBackdropFilter: "blur(4px)" }}>
                    ...
                    <div className="flex-1 min-h-0 overflow-hidden" style={{ minHeight: "160px" }}>
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={energyBarData} margin={{ top: 25, right: 5, left: 5, bottom: 0 }}>
                                <defs>
                                ...
                                <XAxis dataKey="minute" type="number" domain={[-5, 55]} ticks={[0, 10, 20, 30, 40, 50]} tick={renderEnergyXAxisTick} tickLine={false} axisLine={{ stroke: "rgba(107, 114, 128, 0.3)", strokeWidth: 1 }} />

                                <YAxis domain={[energyYAxisConfig.min, energyYAxisConfig.max]} ticks={energyYAxisConfig.ticks} tick={renderEnergyYAxisTick} tickLine={false} axisLine={{ stroke: "rgba(107, 114, 128, 0.3)", strokeWidth: 1 }} width={45} />
                                ...
                                <Bar
                                    ...
                                    label={(props: any) => {
                                        ...
                                        return (
                                            <g>
                                                <foreignObject x={x + width / 2 - 25} y={y - 30} width={50} height={25}>
                    ...
                    <div className="bg-[#2a2d35] px-3 py-2.5 rounded-lg">
                        <div className="flex items-center">
                            ...
                            <div className="flex items-center justify-between flex-1">
                                ...
                                <span className="text-blue-400 text-2xl font-bold transition-all duration-1000">{infrastructureStatus.parkingLots[parkingLotIndex]?.available}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            ...
                            <div className="flex flex-col gap-1.5 bg-[#2a2d35] px-2 py-2 rounded">
                                ...
                                <span className="text-white text-base font-semibold text-right">{infrastructureStatus.parkingLots[parkingLotIndex]?.disabled}</span>
                            </div>
                            ...
                            <div className="flex flex-col gap-1.5 bg-[#2a2d35] px-2 py-2 rounded">
                                ...
                                <span className="text-white text-base font-semibold text-right">{infrastructureStatus.parkingLots[parkingLotIndex]?.women}</span>
                            </div>
                            ...
                            <div className="flex flex-col gap-1.5 bg-[#2a2d35] px-2 py-2 rounded">
                                ...
                                <span className="text-white text-base font-semibold text-right">{infrastructureStatus.parkingLots[parkingLotIndex]?.general}</span>
                            </div>
                        </div>
                    </div>
                </div>

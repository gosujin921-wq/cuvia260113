...
const CCTVMeshTracking: React.FC<CCTVMeshTrackingProps> = ({ event, onClose, cctvIndex, position, width = 420, hideControls = false, isAutoMode = true, isProgressComplete = false, viewAngleAnimationProgress = 0, highlighted = false, onHover, cctvId }) => {

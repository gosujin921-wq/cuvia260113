...
const HeatmapPanel = ({ className = '', areaLabelPrefix = 'Zone', areaLabels, minVisibleCount = 4 }: HeatmapPanelProps) => {
  ...
  return (
    <div className={`rounded-lg p-4 gradient-border-right-bottom flex flex-col ${className}`} style={{ flexShrink: 0, backdropFilter: 'blur(6px)', WebkitBackdropFilter: 'blur(6px)', boxShadow: 'inset -2px -2px 4px rgba(0,0,0,0.3), inset 2px 2px 4px rgba(255,255,255,0.4)' }}>
      ...
      <div className="flex items-center justify-end gap-4 text-[12px] text-white mb-3 drop-shadow-md">

...
export const cctvIconStyles = {
  ...
  light: "w-7 h-7 bg-gradient-to-br from-[#6a6a6a] via-[#5a5a5a] to-[#4a4a4a] border-2 border-gray-400/80 rounded-xl flex items-center justify-center shadow-2xl shadow-gray-700/50 relative hover:scale-110 hover:border-gray-300 hover:shadow-gray-600/70 transition-all duration-300 backdrop-blur-sm",

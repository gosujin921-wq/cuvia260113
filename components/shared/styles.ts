...
export const cctvIconStyles = {
  default: "w-7 h-7 bg-gradient-to-br from-[#4a4a4a] via-[#3a3a3a] to-[#2a2a2a] border-2 border-gray-500/60 rounded-xl flex items-center justify-center shadow-2xl shadow-gray-900/50 relative hover:scale-110 hover:border-gray-400 hover:shadow-gray-800/70 transition-all duration-300 backdrop-blur-sm",
  light: "w-7 h-7 bg-gradient-to-br from-[#4a4a4a] via-[#3a3a3a] to-[#2a2a2a] border-2 border-gray-300/80 rounded-xl flex items-center justify-center shadow-2xl shadow-gray-900/50 relative hover:scale-110 hover:border-gray-200 hover:shadow-gray-800/70 transition-all duration-300 backdrop-blur-sm",
...
export const getCCTVIconClassName = (variant: 'default' | 'light' | 'active' | 'tracking' | 'warning' = 'default') => {

...
export const cctvIconStyles = {
  ...
  light: "w-7 h-7 bg-gradient-to-br from-[#4a4a4a] via-[#3a3a3a] to-[#2a2a2a] border-2 border-gray-300/80 rounded-xl flex items-center justify-center shadow-2xl shadow-gray-900/50 relative backdrop-blur-sm",

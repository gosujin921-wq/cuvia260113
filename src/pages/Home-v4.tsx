...
import EventList from '@/components/dashboard/HOME-v4/EventList';
...
import HeatmapPanel from '@/components/dashboard/HOME-v4/HeatmapPanel';
import BottomPanel from '@/components/dashboard/HOME-v4/BottomPanel';
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div className="glass p-4 flex-1 overflow-hidden" style={{ minHeight: 0 }}>
          <div className="shine" />

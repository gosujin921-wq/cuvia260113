...
const GUIDE_STEPS: GuideStep[] = [
  ...
  },
  {
    ...
    message: '실종자 특징을 기반으로 유사 후보를 탐색했습니다.<br/>검색 결과는 조건 조정과 사용자 피드백을 통해 더욱 정교하게 개선될 수 있습니다.<br/><br/><span style="opacity:0.7; font-weight:600;">직접 해볼 수 있는 기능</span><br/><span style="opacity:0.6">&nbsp;&nbsp;• 상단 반경을 클릭해 탐색 범위를 변경하기</span><br/><span style="opacity:0.6">&nbsp;&nbsp;• CUVIA Link에 비정형 조건 입력하기</span><br/><span style="opacity:0.5">&nbsp;&nbsp;&nbsp;&nbsp;예 : "회색 후드 입은 사람만 보여줘", "우산 쓴 사람은 제외해줘"</span><br/><span style="opacity:0.6">&nbsp;&nbsp;• 후보 카드에서 맞음 / 틀림 선택하기</span><br/><br/>후보 카드를 클릭하면 다음 단계로 넘어갑니다.',
    type: 'eye',
    delayAfterClick: 0,
  },
  {
    ...
    message: '후보가 포착된 클립 영상을 확인하세요.<br/>CUVIA는 후보 영상의 주요 장면을 VLM 기반 텍스트로 요약하고,<br/>신고 정보와 영상 정보를 비교해 유사도 점수를 제공합니다.<br/>이를 통해 대상 여부를 보다 빠르게 판단할 수 있습니다.<br/><br/><span style="opacity:0.7; font-weight:600;">직접 해볼 수 있는 기능</span><br/><span style="opacity:0.6">&nbsp;&nbsp;• 후보 클립 영상 확인</span><br/><span style="opacity:0.6">&nbsp;&nbsp;• 후보 메타 정보 확인 및 유사도 점수 확인</span><br/><br/>대상 포착 버튼을 누르면 해당 인물을 대상으로 확정하고 다음 단계로 진행됩니다.',
    type: 'mouse',
    delayAfterClick: 500,
  },
  {
    id: 'route-analysis',
    message: '포착된 대상을 기반으로 객체추적이 진행됩니다.<br/>대상이 나타난 CCTV와 포착 시각을 분석하여<br/>시간 흐름에 따른 이동 경로를 생성하고 지도 위에 표시합니다.<br/>이동 경로는 애니메이션 형태로 재생되어 대상의 이동 흐름을 한눈에 확인할 수 있습니다.<br/><br/>이 단계는 별도 조작 없이 자동으로 진행되며, 잠시 후 다음 단계로 넘어갑니다.',
    type: 'eye',
    delayAfterClick: 0,
  },
  {
    ...
    message: '마지막 포착 지점을 중심으로 주변 CCTV를 투망감시합니다.<br/>CUVIA는 마지막으로 포착된 CCTV와 이전 포착 지점의 영상을 함께 분석하여,<br/>VLM 기반으로 이동 방향, 보행 동선, 보행로 구조를 파악합니다.<br/>이 정보를 바탕으로 대상이 나타날 가능성이 높은 주변 CCTV를 우선 제안해<br/>보다 정밀한 탐색이 가능하도록 지원합니다.<br/><br/>CCTV 카드 중 하나를 클릭하면 다음 단계로 이동합니다.',
    type: 'eye',
    delayAfterClick: 0,
  },
  {
    ...
    message: '추천된 CCTV 영상에서 대상을 찾아보세요.<br/>CUVIA는 대상이 나타날 가능성이 높은 CCTV를 재생하고,<br/>찾아야 하는 객체의 속성과 함께 이 CCTV를 추천한 상세 근거를 제공합니다.<br/>적합도와 경로 예측 등의 정보를 통해 왜 이 CCTV를 우선 확인해야 하는지 판단할 수 있습니다.<br/><br/>대상 포착 버튼을 누르면 전파할 수 있는 전파 목록으로 이동합니다.',
    type: 'mouse',
    delayAfterClick: 500,
  },
  {
    ...
    message: '포착된 정보를 확인하고 전파 패키지를 생성하세요.<br/>CUVIA는 고속검색, 객체추적 등 이전 단계에서 확보한 대상 정보를 모아<br/>공유할 정보를 선택하고 전파할 수 있도록 지원합니다.<br/><br/><span style="opacity:0.7; font-weight:600;">직접 해볼 수 있는 기능</span><br/><span style="opacity:0.6">&nbsp;&nbsp;• 포착된 대상 카드를 클릭해 시간대별 캡션 설명, 후보 메타 정보 등 상세 내용 확인</span><br/><span style="opacity:0.6">&nbsp;&nbsp;• 공유할 정보 선택</span><br/><span style="opacity:0.6">&nbsp;&nbsp;• 전파 패키지 생성 버튼 클릭</span><br/><br/>전파 패키지 생성 버튼을 누르면 다음 단계로 진행됩니다.',
    type: 'mouse',
    delayAfterClick: 500,
  },
  {
    ...
    message: '전파 패키지를 바탕으로 전파문을 작성하세요.<br/>CUVIA는 지금까지 선택한 클립, 포착 정보, 대상 정보를 종합해<br/>전파문 초안을 자동으로 생성합니다.<br/><br/><span style="opacity:0.7; font-weight:600;">직접 해볼 수 있는 기능</span><br/><span style="opacity:0.6">&nbsp;&nbsp;• AI 생성 전파문 초안 확인 및 수정</span><br/><span style="opacity:0.6">&nbsp;&nbsp;• 최인근 파출소 / 소방서 정보 확인</span><br/><br/>전파 패키지 전송 버튼을 누르면 다음 단계인 전파 스레드로 이동합니다.',
    type: 'mouse',
    delayAfterClick: 500,
  },
  {
    ...
    message: '전파 스레드에서 신고 및 전파 내역을 확인하세요.<br/>수신한 신고 정보와 보낸 전파 내용을 대화형 스레드 형태로 확인할 수 있습니다.<br/><br/><span style="opacity:0.7; font-weight:600;">직접 해볼 수 있는 기능</span><br/><span style="opacity:0.6">&nbsp;&nbsp;• 수신한 신고 정보, 보낸 전파 내용 확인</span><br/><span style="opacity:0.6">&nbsp;&nbsp;• 추가 요청 / 회신 내용 확인</span><br/><span style="opacity:0.6">&nbsp;&nbsp;• 경찰서 처리 결과 확인</span><br/><br/>사건 처리 결과 보고서 다운로드 버튼을 누르면 다음 단계로 진행됩니다.',
    type: 'mouse',
    delayAfterClick: 500,
  },
  {

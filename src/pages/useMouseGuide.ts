...
const GUIDE_STEPS: GuideStep[] = [
  {
    ...
    message: '실종 신고가 접수되었습니다.<br/>마지막 목격 위치와 대상자 정보를 확인하고<br/>수색을 시작하세요.',
    type: 'mouse',
    delayAfterClick: 500,
  },
  {
  ...
  },
  {
    ...
    message: 'AI가 탐색한 후보를 확인하세요.<br/><br/>검색 조건을 추가하면 후보를 더 정확하게 좁힐 수 있습니다.<br/><br/><span style="opacity:0.7">예시</span><br/>• 정형 조건 : 리스트 위의 선택 창에서 검색 반경 또는 시간 범위를 조정<br/>• 비정형 조건 : "우산 쓴 사람은 삭제해줘", "회색 후드 입은 사람만 보여줘"<br/><br/>후보 영상을 확인하고 대상 여부를 선택하세요.',
    type: 'eye',
    delayAfterClick: 0,
  },
  {
    ...
    message: '후보 정보를 확인하세요.<br/>대상으로 판단되면 포착하세요.',
    type: 'mouse',
    delayAfterClick: 500,
  },
  {
    ...
    message: '대상을 포착했습니다.<br/><br/>이동 경로와 다음 포착 가능 CCTV를 확인하려면<br/>\'객체 추적\' 메뉴를 선택하세요.',
    type: 'mouse',
    delayAfterClick: 500,
  },
  {
  ...
  },
  {
    ...
    message: '현장·타기관 공유를 위해<br/>핵심 근거를 패키지로 생성할 수 있습니다.<br/><br/>\'포착 목록\' 메뉴를 선택하세요.',
    type: 'mouse',
    delayAfterClick: 500,
  },
  {
